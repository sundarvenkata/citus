...
# permutation "s1-begin" "s1-update" "s2-update" "s1-commit" "s1-select-count"

# permutations - UPDATE first
# permutation "s1-begin" "s1-update" "s2-delete" "s1-commit" "s1-select-count"
permutation "s1-begin" "s1-update" "s2-truncate" "s1-commit" "s1-select-count"
...
# permutation "s1-begin" "s1-update" "s2-master-modify-multiple-shards" "s1-commit" "s1-select-count"
permutation "s1-drop" "s1-create-non-distributed-table" "s1-begin" "s1-update" "s2-distribute-table" "s1-commit" "s1-select-count"

# permutations - UPDATE second
# permutation "s1-begin" "s1-delete" "s2-update" "s1-commit" "s1-select-count"
permutation "s1-begin" "s1-truncate" "s2-update" "s1-commit" "s1-select-count"
permutation "s1-begin" "s1-drop" "s2-update" "s1-commit" "s1-select-count"
permutation "s1-begin" "s1-ddl-create-index" "s2-update" "s1-commit" "s1-select-count"
permutation "s1-ddl-create-index" "s1-begin" "s1-ddl-drop-index" "s2-update" "s1-commit" "s1-select-count"
permutation "s1-begin" "s1-ddl-add-column" "s2-update" "s1-commit" "s1-select-count"
permutation "s1-ddl-add-column" "s1-begin" "s1-ddl-drop-column" "s2-update" "s1-commit" "s1-select-count"
permutation "s1-begin" "s1-table-size" "s2-update" "s1-commit" "s1-select-count"
# permutation "s1-begin" "s1-master-modify-multiple-shards" "s2-update" "s1-commit" "s1-select-count"
permutation "s1-drop" "s1-create-non-distributed-table" "s1-begin" "s1-distribute-table" "s2-update" "s1-commit" "s1-select-count"
